...
func NewSysConfigHandler(sysConfig *biz.SysConfig) *SysConfigHandler {
	return &SysConfigHandler{biz: sysConfig, Api: api.Api{}}
}
...
// @Security Bearer
func (e SysConfigHandler) GetPage(c *gin.Context) {
...
// @Security Bearer
func (e SysConfigHandler) Get(c *gin.Context) {
...
// @Security Bearer
func (e SysConfigHandler) Insert(c *gin.Context) {
...
// @Security Bearer
func (e SysConfigHandler) Update(c *gin.Context) {
	req := dto.SysConfigControl{}
	err := e.MakeContext(c).
...
// @Security Bearer
func (e SysConfigHandler) Delete(c *gin.Context) {
...
func (e SysConfigHandler) Get2SysApp(c *gin.Context) {
...
// @Accept application/json
// @Product application/json
// @Success 200 {object} response.Response{data=map[string]common{}}	"{"code": 200, "message": "修改成功"}"
// @Router /api/v1/set-config [get]
// @Security Bearer
func (e SysConfigHandler) Get2Set(c *gin.Context) {
...
// @Security Bearer
func (e SysConfigHandler) Update2Set(c *gin.Context) {
	req := make([]dto.GetSetSysConfigReq, 0)
	err := e.MakeContext(c).
		Bind(&req, binding.JSON).
		Errors
...
// @Router /api/v1/sys-config/{id} [get]
// @Security Bearer
func (e SysConfigHandler) GetSysConfigByKEYForService(c *gin.Context) {
