...
import (
	"fmt"
	resp "github.com/mars-projects/mars/common/response"
)
...
type Response struct {
	...
	Host         string `json:"host,omitempty"`         // onvenient for backend Troubleshooting: host of current access compute
}
type response struct {
	Response
